...
{
    // Define the ExcelentPupil constructor (string name)
    // and call the base constructor: base (name)
    // so that it writes the value of the name parameter
    // to constructor ExcelentPupil (string name).
    ...
    {
        Console.WriteLine("Я учу Патерны Проектирования и Code Complete.");
    }

    public override void Read()
    {
        Console.WriteLine("Я читаю stackoverflow.");
    }

    public override void Write()
    {
        Console.WriteLine("Я пишу 500 строк кода в день");
    }
}
